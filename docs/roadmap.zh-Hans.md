...
- [x] 每个 provider 在配置页展示基础凭据类型：
  ...
  - 网页登录授权: Querit、Claude 订阅、Anthropic Credits、Codex 订阅、Kimi 订阅、LongCat、讯飞星火 coding plan、火山引擎 coding plan、OpenCode Go、阿里云 coding plan、腾讯云 coding plan。
...
- [x] 为需要网页登录授权但用户仍要管理业务 API Key 的 provider 增加配套 API Key 保存：
  - Querit、Claude 订阅、Anthropic Credits、Codex 订阅、Kimi 订阅、LongCat、讯飞星火 coding plan、火山引擎 coding plan、OpenCode Go、阿里云 coding plan、腾讯云 coding plan。
